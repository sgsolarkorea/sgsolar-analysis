...
export default function BusinessRoadmapSection() {
  ...
  return (
    <section id="business-roadmap" className="scroll-mt-28 pt-10" aria-labelledby="business-roadmap-heading">
      <p className="text-[15px] text-slate-600">검토 이후 실제 사업은 다음 절차로 진행됩니다.</p>
      <h2 id="business-roadmap-heading" className="mt-2 text-[28px] font-extrabold text-navy sm:text-[32px]">
        사업 진행 로드맵
      </h2>
