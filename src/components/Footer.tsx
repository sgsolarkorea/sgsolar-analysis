...
const footerColumns = [
  [
    { label: "업체명", value: company.companyName },
  ...
  return (
    <footer className="mt-auto border-t border-slate-700 bg-navy text-white">
      <div className="site-shell py-10 sm:py-12">
        <div className="grid gap-10 lg:grid-cols-[minmax(220px,280px)_1fr] lg:gap-14 xl:gap-16">
              ...
              <dl key={columnIndex} className="space-y-4">
                {column.map((item) => (
                  <div key={item.label}>
                    ...
                    <dd className="mt-1 max-w-[18rem] break-keep text-[15px] font-semibold leading-[1.5] text-white sm:max-w-none sm:text-base">
                      {item.value}
                    </dd>
                  </div>
                ))}
